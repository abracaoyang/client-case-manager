...
function getOrCreateSheet() {
  ...
  const targetHeaders = [
    ...
    "ＰＣ訪後討論狀態", "ＰＣ訪後討論備忘", "ＰＣ改期歷史", "Ｃ", "Ｃ已成交", "Ｃ文件準備狀態", 
    "Ｃ文件準備備忘", "Ｃ簽約狀態", "Ｃ簽約日期", "Ｃ補件狀態", "Ｃ補件日期", "Ｃ送件狀態", "Ｃ送件日期", "Ｃ送件已處理", "Ｃ要保簽署狀態", "Ｃ要保簽署日期", "Ｃ保費首扣狀態", "Ｃ保費首扣備忘", "Ｃ改期歷史",
    "Ｓ", "Ｓ保單送達狀態", "Ｓ保單送達備忘", "Ｓ契撤追蹤狀態", "Ｓ週年服務狀態", 
    "Ｓ週年服務備忘", "當前階段", "開拓管道", "客戶來源", "介紹人", "緣故標籤", "ＳＡ備忘", "是否封存", "聯絡資訊", "備註", "議題發想備忘", "Ｃ時段", "Ｓ時段", "最後更新時間"
  ];
  if (!sheet) {
    ...
    const columnsToCheck = [
      ...
      "Ｃ文件準備狀態", "Ｃ文件準備備忘", "Ｃ簽約狀態", "Ｃ簽約日期", "Ｃ補件狀態", "Ｃ補件日期", "Ｃ送件狀態", "Ｃ送件日期", "Ｃ送件已處理", "Ｃ要保簽署日期"
    ];
